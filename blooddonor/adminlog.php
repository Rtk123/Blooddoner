...
<div class="padding">
  ...
  <div class="row mb-3">
    ...
    <button type="submit" class="btn btn-primary" name="login">Login</button>
                    ...
                    ?>
      <h6 style="color:white">New Donor?<a href="adminreg.php">cerate account</a></h6>
    </div>
</div>
</div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-sm-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Ritik Tiwari MUKHARAM KANORIA ROAD 711101</p>
