...
<div class="mb-3">
  ...
  <?php
                    ...
                    if(isset($_POST['add']))
                    {
                      ...
                      if($name!="" && $email!="" && $password!=""&& $blood!=""&& $address!="")
                      {
                  ...
                  ?>
                <h6 style="color:white">Already have an account?<a href="adminlog.php">Sign in</a></h6>   
</div>
</form>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-sm-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>RITIK TIWARI MUKHARAM KANORIA ROAD 711103</p>
