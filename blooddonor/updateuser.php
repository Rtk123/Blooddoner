...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
    <a class="navbar-brand" href="updateuser.php">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="checkrequest.php">check Request</a>
        </li>
        </ul>
        <form class="d-flex">
...
<div class="padding">
  ...
  <a href="showuserdata.php"><button type="button" class="btn btn-primary">view</button></a>
