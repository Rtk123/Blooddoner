...
<html lang="en">
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
    <a class="navbar-brand" href="showadmindata.php">
...
<a href="adminreg.php" class="btn btn-info" style="padding:20px;">Add New admin</a></div>
<table class="table table-dark table-striped">
    ...
    if(mysqli_num_rows($responce)>0)
    {
        while($data = mysqli_fetch_assoc($responce))
        {
            ...
            <td><a href="updateadmin.php?email='.$data["email"].'" class="btn btn-success">update</td>
            </tr>';
            $i++;
        }
    }
